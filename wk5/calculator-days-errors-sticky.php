...
<html lang="en-us">
    ...
    <body>
        ...
        <h1 class="title">Trip Calculator - Days, Errors, Sticky</h1>
                ...
                <label>
                    ...
                    <ul>
                        <li><input type="radio" name="price" value="3" 
                            <?php if( isset($_POST['price']) && $_POST['price'] == '3' ) echo 'checked="checked"'; ?>> $3.00</li>

                        <li><input type="radio" name="price" value="3.5" 
                            <?php if( isset($_POST['price']) && $_POST['price'] == '3.5' ) echo 'checked="checked"'; ?>> $3.50</li>

                        <li><input type="radio" name="price" value="4" 
                            <?php if( isset($_POST['price']) && $_POST['price'] == '4' ) echo 'checked="checked"'; ?>> $4.00</li>
                    </ul>
                ...
                <label>
                    ...
                    <select name="efficiency">
                        <option value="NULL" <?php 
                            if( isset($_POST['efficiency']) && $_POST == 'NULL' ) {
        ...
        <?php
            ...
            if($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                if( empty($_POST['name']) ) {
                    echo '<p class="red box center">Please fill out your name.</p>';
                }

                if( empty($_POST['miles']) ) {
                    echo '<p class="red box center">Please fill out the miles you plan to drive.</p>';
                }

                if( empty($_POST['hours']) ) {
                    echo '<p class="red box center">Please fill out the hours you plan to drive.</p>';
                }

                if( empty($_POST['price']) ) {
                    echo '<p class="red box center">Please select the price of gas.</p>';
                }

                if( $_POST['efficiency'] == 'NULL' ) {
                    echo '<p class="red box center">Please select your fuel efficiency.</p>';
                }
